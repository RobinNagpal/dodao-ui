// src/shared/web3/hooks/useAaveUserPositions.ts
...
import { COMPOUND_MARKETS } from '@/shared/web3/config'; // ← import your Compound list
...
export function useAaveUserPositions(): (wallets: string[]) => Promise<WalletPosition[]> {
