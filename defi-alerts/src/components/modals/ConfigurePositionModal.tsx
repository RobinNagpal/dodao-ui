// src/components/alerts/modals/ConfigurePositionModal.tsx
'use client';
...
interface ConfigurePositionProps {
  isOpen: boolean;
  selectedPosition: WalletPosition | null;
  handleClose: () => void;
  updatePosition: (id: string, changes: Partial<WalletPosition>) => void;
...
export default function ConfigurePositionModal({
  isOpen,
  selectedPosition,
  handleClose,
  updatePosition,
