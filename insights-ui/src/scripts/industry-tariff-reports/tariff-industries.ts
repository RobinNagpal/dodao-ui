export enum TariffIndustryId {
  ...
  commodityChemicals = 'commodityChemicals',
  specialtyChemicals = 'specialtyChemicals',
  fertilizersAndAgriculturalChemicals = 'fertilizersAndAgriculturalChemicals',
  industrialGases = 'industrialGases',
  diversifiedChemicals = 'diversifiedChemicals',
  metalGlassPlasticContainers = 'metalGlassPlasticContainers',
  paperPlasticPackagingProductsAndMaterials = 'paperPlasticPackagingProductsAndMaterials',
  ...
  textiles = 'textiles',
  brewers = 'brewers',
  distillersAndVintners = 'distillersAndVintners',
  softDrinksAndNonAlcoholicBeverages = 'softDrinksAndNonAlcoholicBeverages',
  commercialPrinting = 'commercialPrinting',
  heavyElectricalEquipment = 'heavyElectricalEquipment',
  industrialMachineryAndSupplies = 'industrialMachineryAndSupplies',
  aerospaceAndDefense = 'aerospaceAndDefense',
  constructionMachineryAndHeavyTransportationEquipment = 'constructionMachineryAndHeavyTransportationEquipment',
}
