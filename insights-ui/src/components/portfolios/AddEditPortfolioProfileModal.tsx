            ...
            {isAdmin && (
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-surface border border-border rounded-md text-heading focus:outline-none focus:ring-2 focus:ring-primary"
                >
              ...
              <div className="space-y-2">
                <label className="flex items-center">
                  <input
                    ...
                    className="mr-2 h-4 w-4 text-link focus:ring-primary border-border rounded"
                  />
                  <span className="text-sm font-medium text-heading">Public Profile</span>
                </label>
                <p className="text-sm text-muted">Make this portfolio manager profile visible to all users</p>
              </div>
            )}
          </>
