  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="bg-bg rounded-lg p-4 border border-surface">
        <div className="text-muted-2 text-xs font-medium mb-1">Total Holdings</div>
        <div className="text-2xl font-bold text-heading">{portfolioTickers.length}</div>
      </div>
      <div className="bg-bg rounded-lg p-4 border border-surface">
        <div className="text-muted-2 text-xs font-medium mb-1">Total Allocation</div>
      ...
      <div className="bg-bg rounded-lg p-4 border border-surface">
        <div className="text-muted-2 text-xs font-medium mb-1">Unallocated</div>
        <div className={`text-2xl font-bold ${100 - totalAllocation < 0 ? 'text-red-400' : 'text-muted-1'}`}>{(100 - totalAllocation).toFixed(1)}%</div>
      </div>
    </div>
  );
}
