            ...
            <div className="text-center">
              ...
              <div className="mb-20">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-300 text-lg max-w-2xl mx-auto">Get detailed investment analysis powered by AI</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                  <div className="text-center bg-gray-700/30 backdrop-blur-sm rounded-xl p-6 border border-gray-600/30">
                    <div className="w-12 h-12 mx-auto mb-4 bg-gradient-to-r from-indigo-500 to-blue-600 rounded-lg flex items-center justify-center text-xl">
                      📊
                    </div>
                    <h3 className="text-lg font-semibold text-white mb-2">Stocks Analysis</h3>
                    <p className="text-gray-300 text-sm">5-factor analysis framework covering all dimensions</p>
                  </div>

                  <div className="text-center bg-gray-700/30 backdrop-blur-sm rounded-xl p-6 border border-gray-600/30">
                    <div className="w-12 h-12 mx-auto mb-4 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center text-xl">
                      🤖
                    </div>
                  ...
                  <div className="text-center bg-gray-700/30 backdrop-blur-sm rounded-xl p-6 border border-gray-600/30">
                    <div className="w-12 h-12 mx-auto mb-4 bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg flex items-center justify-center text-xl">
                      ⚡
                    </div>
