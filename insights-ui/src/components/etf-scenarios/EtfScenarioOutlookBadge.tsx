...
const DIRECTION_STYLES: Record<EtfScenarioDirection, { label: string; className: string }> = {
...
const TIMEFRAME_STYLES: Record<EtfScenarioTimeframe, { label: string; className: string }> = {
...
export function EtfScenarioProbabilityBadge({
  bucket,
  percentage,
  asOfDate,
}: {
  bucket: EtfScenarioProbabilityBucket;
...
export function EtfScenarioDirectionBadge({ direction }: { direction: EtfScenarioDirection }): JSX.Element {
...
export function EtfScenarioTimeframeBadge({ timeframe }: { timeframe: EtfScenarioTimeframe }): JSX.Element {
