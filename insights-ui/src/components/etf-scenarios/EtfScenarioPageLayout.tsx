...
function defaultBreadcrumbs(): BreadcrumbsOjbect[] {
  return [
    ...
    { name: 'Scenarios', href: '/etf-scenarios', current: true },
  ];
}

export default function EtfScenarioPageLayout({ title, description, breadcrumbs, rightButton, children }: EtfScenarioPageLayoutProps) {
  return (
    <PageWrapper>
