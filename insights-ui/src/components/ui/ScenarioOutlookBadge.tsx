...
// Shared scenario outlook badges (probability / direction / timeframe pills).
// Stock and ETF scenarios use the same underlying string-literal unions
...
export function DirectionBadge({ direction }: { direction: ScenarioDirection }): JSX.Element {
...
export function TimeframeBadge({ timeframe }: { timeframe: ScenarioTimeframe }): JSX.Element {
