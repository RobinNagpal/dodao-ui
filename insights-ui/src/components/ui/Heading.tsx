...
const heading = cva('', {
  variants: {
    size: { xs: 'text-xs', sm: 'text-sm', md: 'text-base', lg: 'text-lg', xl: 'text-xl', '2xl': 'text-2xl' },
    weight: { medium: 'font-medium', semibold: 'font-semibold', bold: 'font-bold' },
    tone: { default: 'text-gray-100', bright: 'text-gray-200', white: 'text-white', muted: 'text-gray-400', themed: 'text-color' },
  },
