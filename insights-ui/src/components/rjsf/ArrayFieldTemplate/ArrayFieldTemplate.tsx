import { ArrayFieldTemplateItemType, ArrayFieldTemplateProps, FormContextType, getTemplate, getUiOptions, RJSFSchema, StrictRJSFSchema } from '@rjsf/utils';
              ...
              <div className="">
                <div className="mt-2 flex">
                  ...
                  <div className="w-1/4 px-4 py-6">
                    <AddButton className="array-item-add" onClick={onAddClick} disabled={disabled || readonly} uiSchema={uiSchema} registry={registry} />
                  </div>
                </div>
              </div>
            )}
