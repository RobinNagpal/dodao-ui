...
export default function TextareaWidget<T = any, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any>({
  ...
  return (
    <div className="flex">
      <textarea
        className="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-border placeholder:text-muted focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 block-bg-color"
        id={id}
        name={id}
