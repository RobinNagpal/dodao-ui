    ...
    <div className="flex items-center gap-3 mb-6">
      ...
      <div className="relative">
        <DatePicker
          ...
          className="date-picker-input px-4 py-2 border border-color rounded-md background-color text-color focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer"
