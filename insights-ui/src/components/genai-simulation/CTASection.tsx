        ...
        <div className="relative isolate overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 p-12 sm:p-16 text-center">
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                href="/#contact"
                className="group inline-flex items-center justify-center rounded-xl bg-surface px-8 py-4 text-lg font-semibold text-primary shadow-xl hover:bg-surface transition-all duration-300 transform hover:scale-105"
              >
                Get Started Today
