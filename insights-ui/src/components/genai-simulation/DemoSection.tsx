    ...
    <section id="demo" className="relative py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center mb-16">
          <h2 className="text-4xl font-bold text-link">Experience the Simulation</h2>
          <p className="mt-4 text-lg text-muted">See how AI transforms business education</p>
        </div>

        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="aspect-video rounded-2xl border border-border bg-gradient-to-br from-gray-800 to-gray-900 ring-1 ring-white/10 flex items-center justify-center relative overflow-hidden group">
        ...
        <div className="mt-8 flex justify-center">
          <div className="rounded-2xl border border-border bg-gradient-to-br from-gray-800 to-gray-900 ring-1 ring-white/10 relative overflow-hidden group inline-block">
