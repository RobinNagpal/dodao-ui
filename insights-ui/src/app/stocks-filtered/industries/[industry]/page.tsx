// app/stocks-filtered/industries/[industry]/page.tsx
    ...
    <PageWrapper>
      ...
      <div className="w-full mb-8">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4">
          <h1 className="text-2xl font-bold text-white mb-2 sm:mb-0">{industryData?.name || industryKey} Stocks</h1>
        ...
        <p className="text-[#E5E7EB] text-md mb-4">
          Explore {industryData?.name || industryKey} companies listed on US exchanges (NASDAQ, NYSE, AMEX).{' '}
