      ...
      <div className="max-w-7xl mx-auto">
        <div className="py-6">
          ...
          <PortfolioHoldings
            ...
            setDeletingTicker={setDeletingTicker}
            setShowAddTickerModal={setShowAddTickerModal}
          />
        </div>
