...
import AnalysisTabsSection from '@/components/portfolios/AnalysisTabsSection';
...
export default async function PortfolioManagerProfilePage({ params: paramsPromise, searchParams: searchParamsPromise }: PageProps) {
      ...
      <PageWrapper>
        <div className="max-w-7xl mx-auto py-8">
          <div className="bg-surface rounded-lg p-8 text-center">
            ...
            <p className="text-muted-2">The portfolio manager profile you’re looking for doesn’t exist.</p>
          </div>
        </div>
      </PageWrapper>
    );
  ...
  const allFavorites = profile.allFavorites || [];
  const allNotes = profile.allNotes || [];
    ...
    <PageWrapper>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pb-6">
          ...
          {/* Analysis Tabs Section (Industry, Favorites, Notes) */}
          <AnalysisTabsSection
            industriesByCountry={industriesByCountry}
