...
export default function CountryPortfolioManagersPage() {
  ...
  if (profilesLoading) {
    return <FullPageLoader message="Loading portfolio managers..." />;
  }
        ...
        <div className="py-6">
          ...
          {profiles.length === 0 ? (
            <div className="bg-gray-800 rounded-lg p-8 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">No portfolio managers found</h3>
              <p className="text-gray-400">There are no famous portfolio managers from {country} yet.</p>
            </div>
          ) : (
