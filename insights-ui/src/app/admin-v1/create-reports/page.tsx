...
export default function CreateReportsV1Page(): JSX.Element {
  return (
    <TickerSelectionPage
      ...
      renderActionComponent={({ selectedTickers, tickerData, onReportsGenerated }) => (
        <ReportGenerator selectedTickers={selectedTickers} tickerReports={tickerData} onReportsGenerated={onReportsGenerated} />
      )}
    />
  );
}
