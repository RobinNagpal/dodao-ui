  ...
  return (
    <div className="relative flex flex-auto items-center">
      ...
      <Container className="flex flex-col items-center py-16 text-center sm:py-20 lg:py-32">
        <p className="rounded-full px-4 py-1 text-base font-medium tracking-tight text-heading ring-1 ring-border ring-inset">404</p>
        <h1 className="mt-6 font-display text-5xl font-extrabold text-heading sm:text-6xl">Page not found</h1>
        <p className="mt-4 text-lg tracking-tight text-muted">Sorry, we couldn’t find the page you’re looking for.</p>
