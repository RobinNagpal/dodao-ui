...
export default async function AboutConsumptionPage({ params }: { params: Promise<{ industrySlug: string }> }) {
  ...
  return (
    <div>
      <div className="flex justify-end mb-4">
        <PrivateWrapper>
          <IntroductionSectionActions industrySlug={industrySlug} sectionKey="aboutConsumption" sectionName="About Consumption" />
        </PrivateWrapper>
      </div>
