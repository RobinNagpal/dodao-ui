...
export default async function PositiveTariffImpactPage({ params }: { params: Promise<{ industrySlug: string; index: string }> }) {
      ...
      <div className="flex justify-end mb-4">
        <PrivateWrapper>
          <EvaluateIndustryAreasActions
            ...
            subSection="positiveTariffImpactOnCompanyType"
          />
        </PrivateWrapper>
      </div>
