...
export default async function NegativeTariffImpactPage({ params }: { params: Promise<{ reportId: string; index: string }> }) {
  ...
  return (
    <div>
      <div className="flex justify-end mb-4">
        <PrivateWrapper>
          <EvaluateIndustryAreasActions reportId={reportId} areaIndex={areaIndex} areaTitle={area.title} subSection="negativeTariffImpactOnCompanyType" />
        </PrivateWrapper>
      </div>
