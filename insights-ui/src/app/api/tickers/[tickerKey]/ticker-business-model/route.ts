...
async function saveTickerBusinessModel(
  req: NextRequest,
...
async function upsertTickerBusinessModel(
  req: NextRequest,
  _userContext: KoalaGainsJwtTokenPayload | null,
  { params }: { params: Promise<{ tickerKey: string }> }
): Promise<Ticker> {
...
export const PUT = withAdminOrToken<Ticker>(upsertTickerBusinessModel);
export const POST = withAdminOrToken<Ticker>(saveTickerBusinessModel);
