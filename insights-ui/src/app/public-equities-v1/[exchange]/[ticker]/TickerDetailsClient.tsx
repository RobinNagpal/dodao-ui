...
interface TickerDetailsClientProps {
  tickerData: TickerV1ReportResponse;
  exchange: string;
  ticker: string;
}

export default function TickerDetailsClient({ tickerData, exchange, ticker }: TickerDetailsClientProps) {
  ...
  const comparisonButton = {
    text: 'Compare',
    icon: <ScaleIcon className="w-4 h-4" aria-hidden="true" />,
    onClick: handleCompareClick,
  };

  return (
    <PageWrapper>
      <Breadcrumbs breadcrumbs={breadcrumbs} rightButton={comparisonButton} />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-2">
        ...
        <ComparisonModal
          ...
          currentTicker={{
            ...
            industryKey: tickerData.industryKey,
            subIndustryKey: tickerData.subIndustryKey,
          }}
        />
      </div>
    </PageWrapper>
