...
export const getCacheTagForIndustry = (industryKey: string) => `TICKERS_INDUSTRY_TAG:${industryKey}`;
...
export const revalidateIndustry = (industryKey: string) => {
  return revalidateTag(getCacheTagForIndustry(industryKey));
};
