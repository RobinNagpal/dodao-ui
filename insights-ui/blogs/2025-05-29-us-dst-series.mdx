...
|-----------------------------------------|------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------|
| **Franchise tax – master**              | **\$0**                                              | **\$300**                                               | Biggest fixed delta.                                |
| **Franchise tax – per series**          | \$0                                                  | *Protected* Series \$0; *Registered* Series **\$75/yr** | Adds up quickly for iterative launches.             |
| **Annual report filing**                | None                                                 | None                                                    | DE treats the \$300 payment as the report for LLCs. |
| **Registered‑agent service**            | \$50–300/yr                                          | Same                                                    | One fee covers the master in most engagements.      |
...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ----------------------------------- |
| **Statutory firewall**        | § 3804(a): liabilities “enforceable only against that series”                          | § 18‑215(b) mirrors language for protected/registered series  | Wording is nearly identical.        |
| **Courtroom track record**    | \~9,000 mutual‑fund series built on DST chassis; two decades of fund litigation  | Very few published decisions yet; concept newer                                | Institutional LPs value precedents. |
| **Record‑keeping conditions** | Separate books, bank accounts, contracts—non‑negotiable (statute + case law)              | Same statutory mandate                                                         | Shield collapses if commingled.     |
...
| ------------------------------------ | -------------------------------------------------------------------------------- | -------------------------------------------------------- | ------------------------------------------------------ |
| **Default tax status (multi‑owner)** | **Grantor trust** (if passive)  | Partnership (Form 1065)                                  | Trust passes income straight through—no entity return. |
| **Investor paperwork**               | Grantor Letter (1‑2 pages)                     | Schedule K‑1 (often lengthy)  | Simpler & earlier delivery for DST investors.          |
...
| **1031 exchange eligibility**        | **Yes** – Rev. Rul. 2004‑86                          | No – partnership interests excluded                      | Crucial for tokenized real‑estate strategies.          |
...
| ------------------------- | -------------------------------------------------------------- | --------------------------------------------------------------- |
| **Institutional finance** | Very familiar (mirrors mutual‑fund series)  | Adequate but less common                                        |
