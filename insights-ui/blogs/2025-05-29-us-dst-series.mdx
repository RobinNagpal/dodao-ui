...
| ---------------------------------------- | -------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| **State charter filing**                 | Certificate of Trust – **\$500** ([Delaware Corporations][1])        | Certificate of Formation – **\$90** ([corpfiles.delaware.gov][2])                                                                               | Master‑level cost delta is only incurred once.                         |
| **Statutory notice of series liability** | Must appear in Certificate (§ 3804(a)) ([Delaware Code Online][3])   | Must appear in Certificate (§ 18‑215(b)) ([Justia Law][4])                                                                                      | Missing the notice voids the firewall.                                 |
| **Internal series creation**             | Trustee resolution + Series Appendix — **no Delaware filing or fee** | • *Protected* Series: internal only. • *Registered* Series: file Certificate of Registered Series – **\$90 each** ([corpfiles.delaware.gov][5]) | DST wins on speed and privacy; LLC gives public visibility if desired. |
| **Per‑series EIN**                       | Required (free IRS Form SS‑4).                                       | Same.                                                                                                                                           | Needed to open bank/custody accounts.                                  |
| **Typical outside legal**¹               | \$10k–25k master docs; \$0.75k–2.5k per Series Appendix              | \$7k–20k master docs; \$0.5k–2k per series designation                                                                                          | These are market averages, **not** state fees.                         |
| **Delaware trustee requirement**         | Yes—must be DE resident or DE business presence                      | N/A (registered agent only)                                                                                                                     | Adds governance layer but anchors nexus.                               |

> ¹Ranges from recent Delaware boutique quotes; complexity, investor type, and leverage docs drive variance.
...
| --------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| **Franchise tax – master**              | **\$0** ([Delaware Inc.][6])                         | **\$300** ([Delaware Corporations][7])                                                                     | Biggest fixed delta.                                |
| **Franchise tax – per series**          | \$0                                                  | *Protected* Series \$0; *Registered* Series **\$75/yr** ([corpfiles.delaware.gov][5], [Cogency Global][8]) | Adds up quickly for iterative launches.             |
| **Annual report filing**                | None                                                 | None                                                                                                       | DE treats the \$300 payment as the report for LLCs. |
| **Registered‑agent service**            | \$50–300/yr ([Stripe][9])                            | Same ([IncNow][10])                                                                                        | One fee covers the master in most engagements.      |
| **Delaware trustee fee (if corporate)** | Market‑based; often folded into legal/admin retainer | N/A                                                                                                        | Only for DST.                                       |


**Recurring Costs**
| Cost Bucket                    | **DST – Master**               | **DST – Each Series** | **LLC – Master**    | **LLC – Protected Series** | **LLC – Registered Series** |
| ------------------------------ | ------------------------------ | --------------------- | ------------------- | -------------------------- | --------------------------- |
| **Formation filing**           | \$500                          | \$0                   | \$90                | \$0                        | \$90                        |
| **Outside legal (est.)**       | 10 k–25 k                      | 0.75 k–2.5 k          | 7 k–20 k            | 0.5 k–2 k                  | same                        |
| **Franchise tax (annual)**     | **\$0**                        | \$0                   | **\$300**           | \$0                        | **\$75**                    |
| **Registered‑agent / trustee** | 50–300 / trustee‑as‑applicable | —                     | 50–300              | —                          | —                           |
| **Visibility of series**       | Private                        | Private               | Private (Protected) | Private                    | Public filing               |
...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ----------------------------------- |
| **Statutory firewall**        | § 3804(a): liabilities “enforceable only against that series” ([Delaware Code Online][3])                         | § 18‑215(b) mirrors language for protected/registered series ([Justia Law][4]) | Wording is nearly identical.        |
| **Courtroom track record**    | \~9,000 mutual‑fund series built on DST chassis; two decades of fund litigation ([Richards, Layton & Finger][11]) | Very few published decisions yet; concept newer                                | Institutional LPs value precedents. |
| **Record‑keeping conditions** | Separate books, bank accounts, contracts—non‑negotiable (statute + case law) ([Morris James LLP][12])             | Same statutory mandate                                                         | Shield collapses if commingled.     |
...
| -------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| **Decision makers**              | Trustee(s) (often a Manager LLC) owe default fiduciary duties of loyalty & care | Manager‑managed or member‑managed; duties modifiable (§ 18‑1101(c)) | Investors may perceive trustees as more “institutionally familiar.” |
| **Adding external sub‑advisors** | Manager LLC contracts at the series level—liability isolated                    | Possible but must draft into Operating Agreement                    | Useful for multi‑asset‑class RWA plays.                             |
| **Amending governing document**  | Trust Agreement amendment; no state filing                                      | Operating Agreement amendment; no state filing                      | Same practical effort.                                              |
...
| ------------------------------------ | -------------------------------------------------------------------------------- | -------------------------------------------------------- | ------------------------------------------------------ |
| **Default tax status (multi‑owner)** | **Grantor trust** (if passive) ([Delaware Inc.][6], [dstproperties1031.com][13]) | Partnership (Form 1065)                                  | Trust passes income straight through—no entity return. |
| **Investor paperwork**               | Grantor Letter (1‑2 pages) ([fscap.net][14], [Tax Shark][15])                    | Schedule K‑1 (often lengthy) ([Accounting Insights][16]) | Simpler & earlier delivery for DST investors.          |
| **Non‑U.S. ECI exposure**            | Lower for passive portfolio assets                                               | Higher; partnership can be U.S. trade or business        | Key selling point for global LPs.                      |
| **1031 exchange eligibility**        | **Yes** – Rev. Rul. 2004‑86 ([Exeter 1031 Exchange][17])                         | No – partnership interests excluded                      | Crucial for tokenized real‑estate strategies.          |
...
| ------------------- | -------------------------------------------------------------- | ------------------------ | -------------------------------------------------- |
| **Reg D 506(b)**    | Unlimited accredited + ≤ 35 sophisticated, **no solicitation** | Same                     | Both rely on pre‑existing relationships.           |
| **Reg D 506(c)**    | Accredited‑only, **general solicitation OK**                   | Same                     | Verification burden identical.                     |
| **’40 Act 3(c)(1)** | ≤ 100 beneficial owners per series investing in securities     | ≤ 100 members per series | Practical ceiling for many RWA funds.              |
| **’40 Act 3(c)(7)** | Unlimited **qualified purchasers**                             | Same                     | Higher wealth threshold; often paired with 506(c). |
...
| Operational Task                    | Requirement (Both Structures)                                    | Typical Cost Range                                  | Why it Matters                                    |
| ----------------------------------- | ---------------------------------------------------------------- | --------------------------------------------------- | ------------------------------------------------- |
| **Bank/custody account per series** | Separate titling (“\[Mgr LLC] as Trustee for \[DST] – Series X”) | Bank fees vary; admin time                          | Satisfies statutory segregation.                  |
| **Bookkeeping & tax prep**          | Distinct ledgers, GAAP or IFRS roll‑ups                          | \$0.75k–3 k per series/yr (no smart‑contract costs) | Data trail supports liability firewall and audit. |
| **Fund administrator (if scaled)**  | Optional but common > \$25 m AUM                                 | \$10k–25 k + per series/yr                          | Offloads NAV & investor services.                 |
| **Audit (on demand)**               | Compilation \$1.5k+; Review \$4k+; Audit \$7k–25 k               | Investor or lender driven                           | Adds credibility for institutional capital.       |
...
| -------------------- | --------------------------------------------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------- |
| **Internal affairs** | DE Superior Court (money damages) or Court of Chancery (equity) | **Court of Chancery** (statutory jurisdiction) | Chancery is renowned for business expertise, giving LLCs slight procedural advantage. |
...
| ------------------------- | -------------------------------------------------------------- | --------------------------------------------------------------- |
| **Institutional finance** | Very familiar (mirrors mutual‑fund series) ([Fin Insight][18]) | Adequate but less common                                        |
| **Crypto/Web3 founders**  | Requires some education                                        | Instantly familiar (“LLC with slices”)                          |
| **Commercial banks**      | May quiz on trustee powers; appreciate DE statute once shown   | May quiz on series concept; registered series certificate helps |
...
|:---|:--------------------------------------------|:-------------------------------------------------------------------|:---------------------------------------------------------------------|:--------------------------------------------------------------------------|
| 1  | Governing Statute                           | 12 Del C. § 3801 et seq. (DSTA)                                    | 6 Del C. § 18-101 et seq. (DLLCA)                                    | Both are mature, Delaware-enacted frameworks.                             |
| 2  | Primary Governing Document                  | Trust Agreement                                                    | Operating Agreement                                                  | Both permit broad contractual customization.                              |
| 3  | Formation Document (State)                  | Certificate of Trust                                               | Certificate of Formation                                             | Filed with the Delaware Division of Corporations.                         |
| 4  | Notice of Series Liability                  | Must appear in Certificate of Trust (§ 3804(a))                    | Must appear in Certificate of Formation (§ 18-215(b))                | Required for the statutory “internal firewall.”                           |
| 5  | Key Parties                                 | Settlor, Trustee(s), Beneficial Owners                             | Member(s), Manager(s)                                                | Different relational and governance frameworks.                           |
| 6  | Nature of Relationship                      | Primarily fiduciary (trustee → beneficiary)                        | Primarily contractual/business (among members/managers)              | Both duties can be trimmed by agreement, but trust duties start stronger. |
| 7  | Initial State Filing Fee                    | **\$500** (Certificate of Trust)                                   | **\$90** (Certificate of Formation)                                  | One-time formation cost differential.                                     |
| 8  | Series Creation (Internal)                  | Trustee resolution + Series Appendix (no state filing)             | Amendment to Operating Agreement (no state filing)                   | Both allow internal series launches without extra filings.                |
| 9  | Series State Filing (Optional/Required)     | None                                                               | Certificate of Registered Series – **\$75 each**                     | LLC may choose to publish a public series certificate.                    |
| 10 | Annual DE Franchise Tax (Master)            | **\$0** (no DST franchise tax)                                     | **\$300** per year                                                   | Major recurring cost gap.                                                 |
| 11 | Annual DE Franchise Tax (Series)            | **\$0 per series**                                                 | Protected Series \$0; Registered Series **\$75/yr**                  | Scales up expense for LLC with multiple registered series.                |
| 12 | Annual DE Report                            | None                                                               | None (tax payment suffices)                                          | Both are exempt from formal annual reporting.                             |
| 13 | Default Fed Tax (Multi-Owner)               | Grantor trust (pass-through)                                       | Partnership (Form 1065)                                              | Impacts entity-level filing.                                              |
| 14 | Investor Tax Reporting (US)                 | Grantor Letter                                                     | Schedule K-1                                                         | K-1s can be complex and delayed; trust letter is simpler.                 |
| 15 | Non-US Investor ECI Risk                    | Generally lower (passive portfolio assets)                         | Generally higher (partnership may be treated as U.S. trade/business) | Key for attracting global LPs.                                            |
| 16 | 1031 Exchange (Real Estate)                 | **Yes** (IRS Rev. Rul. 2004-86)                                    | No (partnership interests explicitly excluded)                       | Crucial for tokenized real-estate deployments.                            |
| 17 | Fiduciary Duties                            | Strong default under DSTA (§ 3806(e)); modifiable                  | Default under DLLCA (§ 18-1101); modifiable                          | Trust model signals higher fiduciary baseline.                            |
| 18 | Legal Precedent (Series)                    | Extensive (mutual-fund DST chassis)                                | Limited (newer LLC series provisions)                                | DST firewall is more “battle-tested.”                                     |
| 19 | DE Court (Internal Affairs)                 | Superior Court; Court of Chancery (equity matters)                 | Court of Chancery                                                    | LLCs benefit from dedicated Chancery jurisdiction.                        |
| 20 | DE Trustee / Registered Office & Agent Cost | Requires DE Trustee or RA (**\$50–300/yr**)                        | Requires DE Registered Agent (**\$50–300/yr**)                       | DST adds trustee-situs requirement; RA cost is similar.                   |
| 21 | Asset Titling for Series                    | “\[Trustee] as Trustee for \[Trust] – Series X”                    | “\[Master LLC] – Series X” or “for benefit of Series X”              | Titles must precisely reflect the series identity.                        |
| 22 | Investor Cap (Reg D)                        | Same Reg D 506(b)/(c) limits                                       | Same                                                                 | Both follow identical securities-offering rules.                          |
| 23 | ’40 Act Considerations                      | ≤ 100 beneficial owners or QPs per series                          | ≤ 100 members or QPs per series                                      | Avoids Investment Company Act registration.                               |
| 24 | Banking Onboarding                          | Must educate banks on “trust + series” concept                     | Must educate banks on “series” structure                             | Complexity can slow account setup.                                        |
| 25 | General Business Familiarity                | Less familiar outside finance/RE circles                           | LLC widely understood; Series LLC steadily growing                   | LLC often easier for general practitioners.                               |
| 26 | Amendment of Master Document                | Amend Trust Agreement; no DE filing                                | Amend Operating Agreement; no DE filing                              | Similar procedural effort.                                                |
| 27 | Privacy (Series Creation)                   | New series never publicly filed                                    | Protected Series private; Registered Series public                   | DST offers greater stealth for internal launches.                         |
| 28 | Use with DAOs / DAO Integration             | Emerging templates; Manager LLC can act as DAO-controlled          | Numerous DAO frameworks (e.g. LAOs)                                  | LLC currently has broader off-the-shelf options.                          |
| 29 | Suitability for Passive Holds               | Excellent (grantor-trust simplicity)                               | Good (partnership pass-through)                                      | DST easier for purely passive investment vehicles.                        |
| 30 | Suitability for Active Business             | Possible (corporate-tax election available)                        | Excellent (designed for ongoing operations)                          | LLC more natural for active trade or services.                            |
| 31 | Blockchain Integration                      | Tokens as beneficial interests; on-chain NAV & governance possible | Tokens as membership interests; similar on-chain potential           | DST’s “beneficial interest” model aligns neatly with tokenization.        |
| 32 | Scalability / Exit Options                  | Internal series growth; statutory conversions/mergers familiar     | Similar scalability paths                                            | DST’s use in registered funds offers known exit frameworks.               |
| 33 | Use in Mutual-Fund Industry                 | Standard chassis for \~9,000+ funds                                | Rare                                                                 | DST’s widespread adoption bolsters institutional credibility.             |
