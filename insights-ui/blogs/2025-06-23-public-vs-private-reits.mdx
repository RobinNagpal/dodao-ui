...
Non-listed REITs often levy upfront sales commissions of up to **7 %** of the offering proceeds and annual asset-management fees in the **1.0 %–2.0 %** range; these higher fees compensate sponsors for maintaining periodic redemption facilities and additional marketing efforts ([ reit.com](https://www.reit.com/news/blog/market-commentary/what-are-the-structural-factors-that-boost-long-term-reit-performance)).
...
* **Blackstone Real Estate Income Trust (BREIT)** – A non-traded REIT offering diversified exposure to U.S. core and core-plus properties across sectors [Blackstone](https://www.blackstone.com/real-estate/).
* **Starwood Real Estate Income Trust (SREIT)** – Invests in stabilized, cash-flow properties with a focus on industrial and office assets [Starwood Capital](https://www.starwoodcapital.com/).
* **Griffin Capital Essential Asset REIT (NYSE: EARN)** – Non-traded REIT specializing in mission-critical properties like single-tenant industrial and infrastructure [Griffin Capital](https://griffincapital.com/).
* **Nuveen Real Estate Income Fund (JRS)** – Provides periodic NAV redemptions and income through a diversified U.S. real-estate portfolio [Nuveen](https://www.nuveen.com/).
...
| **Minimum Investment**         | Depends, usually `$1,000` to about `$2,500` per share | Typically range from `$1,000` to `$2,500`  | At least `$10,000` to `$100,000`   |
