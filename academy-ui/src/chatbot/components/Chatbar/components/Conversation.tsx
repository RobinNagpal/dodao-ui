...
import SidebarActionButton from '@/chatbot/components/Buttons/SidebarActionButton';
    ...
    <div className="relative flex items-center">
      {isRenaming && selectedConversation?.id === conversation.id ? (
        <div className="flex w-full items-center gap-3 rounded-lg p-3">
          <IconMessage size={18} />
          <input
            className="mr-12 flex-1 overflow-hidden overflow-ellipsis border-neutral-400 text-left text-[12.5px] leading-3 outline-none"
            type="text"
            value={renameValue}
      ...
      {(isDeleting || isRenaming) && selectedConversation?.id === conversation.id && (
        <div className="z-10 flex text-gray-300">
