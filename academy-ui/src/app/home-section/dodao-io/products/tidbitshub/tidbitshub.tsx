    ...
    <div>
                ...
                <div className="sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:text-left">
                  <h1>
                    <span className="mt-1 block text-4xl font-bold tracking-tight sm:text-6xl">
                      <span className="block text-primary">Tidbits Hub</span>
                    </span>
                  </h1>
                  ...
                  <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
                    <div className="rounded-md shadow">
                      <a
                        ...
                        className="flex w-full items-center justify-center rounded-md border border-transparent bg-primary px-8 py-3 text-base font-medium text-primary-text hover:bg-primary/85 md:px-10 md:py-4 md:text-lg"
                      >
                        Get started
                      </a>
                    </div>
      ...
      <div className="relative bg-bg py-20 sm:py-28 lg:py-36">
        <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-heading sm:text-5xl">Features of the Solution</h2>
      ...
      <div className="bg-bg">
        <div className="relative bg-surface pb-32">
          ...
          <div className="relative mx-auto max-w-7xl px-6 py-20 sm:py-28 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight text-heading sm:text-5xl">Benefits of the Solution</h1>
            <p className="mt-6 max-w-3xl text-base text-body">Compress hours of content into minutes, enabling faster onboarding.</p>
          </div>
        </div>
