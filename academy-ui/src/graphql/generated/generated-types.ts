...
export interface SpaceIntegrations {
  ...
  spaceApiKeys: Array<Maybe<SpaceApiKey>>;
}
...
export interface SpaceIntegrationsInput {
  ...
  spaceApiKeys: Array<InputMaybe<SpaceApiKeyInput>>;
}
