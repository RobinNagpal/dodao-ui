...
export interface ByteCollectionDemo {
  __typename?: 'ByteCollectionDemo';
...
export type AcademyTaskFragmentFragment = { __typename?: 'AcademyTask', uuid: string, createdAt: number, createdBy: string, excerpt: string, spaceId: string, status: string, details: string, title: string, updatedAt: number, updatedBy: string, prerequisiteCourses: Array<{ __typename?: 'SummarizedGitCourse', uuid: string, key: string, title: string, thumbnail: string }>, prerequisiteGuides: Array<{ __typename?: 'Guide', uuid: string, guideName: string, content: string, thumbnail?: string | null, guideType: string }>, items: Array<{ __typename: 'GuideQuestion', answerKeys: Array<string>, content: string, order: number, type: string, uuid: string, choices: Array<{ __typename?: 'QuestionChoice', content: string, key: string }> } | { __typename: 'GuideUserInput', label: string, order: number, required: boolean, type: string, uuid: string } | { __typename: 'UserDiscordConnect', type: string, uuid: string }> };
...
export type AcademyTasksQuery = { __typename?: 'Query', academyTasks?: Array<{ __typename?: 'AcademyTask', uuid: string, createdAt: number, createdBy: string, excerpt: string, spaceId: string, status: string, details: string, title: string, updatedAt: number, updatedBy: string, prerequisiteCourses: Array<{ __typename?: 'SummarizedGitCourse', uuid: string, key: string, title: string, thumbnail: string }>, prerequisiteGuides: Array<{ __typename?: 'Guide', uuid: string, guideName: string, content: string, thumbnail?: string | null, guideType: string }>, items: Array<{ __typename: 'GuideQuestion', answerKeys: Array<string>, content: string, order: number, type: string, uuid: string, choices: Array<{ __typename?: 'QuestionChoice', content: string, key: string }> } | { __typename: 'GuideUserInput', label: string, order: number, required: boolean, type: string, uuid: string } | { __typename: 'UserDiscordConnect', type: string, uuid: string }> }> | null };
...
export type GuideSummaryFragment = { __typename?: 'Guide', id: string, authors: Array<string>, guideName: string, categories: Array<string>, content: string, createdAt: any, guideSource: string, guideType: string, publishStatus: string, thumbnail?: string | null, uuid: string, priority?: number | null };
...
export type GuidesQueryQuery = { __typename?: 'Query', guides: Array<{ __typename?: 'Guide', id: string, authors: Array<string>, guideName: string, categories: Array<string>, content: string, createdAt: any, guideSource: string, guideType: string, publishStatus: string, thumbnail?: string | null, uuid: string, priority?: number | null }> };
...
export type GuideFragment = { __typename?: 'Guide', authors: Array<string>, categories: Array<string>, postSubmissionStepContent?: string | null, content: string, createdAt: any, id: string, guideSource: string, guideType: string, guideName: string, publishStatus: string, priority?: number | null, thumbnail?: string | null, uuid: string, version: number, guideIntegrations: { __typename?: 'GuideIntegrations', discordRoleIds?: Array<string> | null, discordRolePassingCount?: number | null, discordWebhook?: string | null, projectGalaxyCredentialId?: string | null, projectGalaxyOatMintUrl?: string | null, projectGalaxyOatPassingCount?: number | null }, steps: Array<{ __typename?: 'GuideStep', content: string, id: string, stepName: string, stepOrder: number, uuid: string, stepItems: Array<{ __typename: 'GuideQuestion', answerKeys: Array<string>, content: string, order: number, type: string, uuid: string, explanation?: string | null, choices: Array<{ __typename?: 'QuestionChoice', content: string, key: string }> } | { __typename: 'GuideUserInput', label: string, order: number, required: boolean, type: string, uuid: string } | { __typename: 'UserDiscordConnect', type: string, uuid: string }> }> };
...
export type ProjectByteCollectionFragment = { __typename?: 'ProjectByteCollection', byteIds: Array<string>, description: string, id: string, name: string, status: string, archived: boolean, priority: number, videoUrl?: string | null, bytes: Array<{ __typename?: 'ByteCollectionByte', byteId: string, name: string, content: string, videoUrl?: string | null }>, demos: Array<{ __typename?: 'ByteCollectionDemo', demoId: string, title: string, excerpt: string, steps: Array<{ __typename?: 'ClickableDemoStep', id: string, url: string, selector: string, tooltipInfo: string, placement: string, order: number }> }>, seoMeta?: { __typename?: 'SEOMeta', title: string, description: string, keywords: Array<string> } | null };
...
export type ProjectByteCollectionsQuery = { __typename?: 'Query', projectByteCollections: Array<{ __typename?: 'ProjectByteCollection', byteIds: Array<string>, description: string, id: string, name: string, status: string, archived: boolean, priority: number, videoUrl?: string | null, bytes: Array<{ __typename?: 'ByteCollectionByte', byteId: string, name: string, content: string, videoUrl?: string | null }>, demos: Array<{ __typename?: 'ByteCollectionDemo', demoId: string, title: string, excerpt: string, steps: Array<{ __typename?: 'ClickableDemoStep', id: string, url: string, selector: string, tooltipInfo: string, placement: string, order: number }> }>, seoMeta?: { __typename?: 'SEOMeta', title: string, description: string, keywords: Array<string> } | null }> };
...
export type ProjectByteCollectionQuery = { __typename?: 'Query', projectByteCollection: { __typename?: 'ProjectByteCollection', byteIds: Array<string>, description: string, id: string, name: string, status: string, archived: boolean, priority: number, videoUrl?: string | null, bytes: Array<{ __typename?: 'ByteCollectionByte', byteId: string, name: string, content: string, videoUrl?: string | null }>, demos: Array<{ __typename?: 'ByteCollectionDemo', demoId: string, title: string, excerpt: string, steps: Array<{ __typename?: 'ClickableDemoStep', id: string, url: string, selector: string, tooltipInfo: string, placement: string, order: number }> }>, seoMeta?: { __typename?: 'SEOMeta', title: string, description: string, keywords: Array<string> } | null } };
...
export type UpsertProjectByteCollectionMutation = { __typename?: 'Mutation', upsertProjectByteCollection: { __typename?: 'ProjectByteCollection', byteIds: Array<string>, description: string, id: string, name: string, status: string, archived: boolean, priority: number, videoUrl?: string | null, bytes: Array<{ __typename?: 'ByteCollectionByte', byteId: string, name: string, content: string, videoUrl?: string | null }>, demos: Array<{ __typename?: 'ByteCollectionDemo', demoId: string, title: string, excerpt: string, steps: Array<{ __typename?: 'ClickableDemoStep', id: string, url: string, selector: string, tooltipInfo: string, placement: string, order: number }> }>, seoMeta?: { __typename?: 'SEOMeta', title: string, description: string, keywords: Array<string> } | null } };
...
export type UpdateArchivedStatusOfProjectByteCollectionMutation = { __typename?: 'Mutation', updateArchivedStatusOfProjectByteCollection: { __typename?: 'ProjectByteCollection', byteIds: Array<string>, description: string, id: string, name: string, status: string, archived: boolean, priority: number, videoUrl?: string | null, bytes: Array<{ __typename?: 'ByteCollectionByte', byteId: string, name: string, content: string, videoUrl?: string | null }>, demos: Array<{ __typename?: 'ByteCollectionDemo', demoId: string, title: string, excerpt: string, steps: Array<{ __typename?: 'ClickableDemoStep', id: string, url: string, selector: string, tooltipInfo: string, placement: string, order: number }> }>, seoMeta?: { __typename?: 'SEOMeta', title: string, description: string, keywords: Array<string> } | null } };
...
export type UpdateSeoOfProjectByteCollectionMutation = { __typename?: 'Mutation', updateSeoOfProjectByteCollection: { __typename?: 'ProjectByteCollection', byteIds: Array<string>, description: string, id: string, name: string, status: string, archived: boolean, priority: number, videoUrl?: string | null, bytes: Array<{ __typename?: 'ByteCollectionByte', byteId: string, name: string, content: string, videoUrl?: string | null }>, demos: Array<{ __typename?: 'ByteCollectionDemo', demoId: string, title: string, excerpt: string, steps: Array<{ __typename?: 'ClickableDemoStep', id: string, url: string, selector: string, tooltipInfo: string, placement: string, order: number }> }>, seoMeta?: { __typename?: 'SEOMeta', title: string, description: string, keywords: Array<string> } | null } };
...
export type UpsertProjectShortVideoMutation = { __typename?: 'Mutation', upsertProjectShortVideo: { __typename?: 'ProjectShortVideo', id: string, title: string, description: string, thumbnail: string, videoUrl: string, priority: number, createdAt: string, updatedAt: string, archived: boolean, seoMeta?: { __typename?: 'SEOMeta', title: string, description: string, keywords: Array<string> } | null } };
...
export type UpdateArchivedStatusOfProjectShortVideoMutation = { __typename?: 'Mutation', updateArchivedStatusOfProjectShortVideo: { __typename?: 'ProjectShortVideo', id: string, title: string, description: string, thumbnail: string, videoUrl: string, priority: number, createdAt: string, updatedAt: string, archived: boolean, seoMeta?: { __typename?: 'SEOMeta', title: string, description: string, keywords: Array<string> } | null } };
...
export type UpdateSeoOfProjectShortVideoMutation = { __typename?: 'Mutation', updateSeoOfProjectShortVideo: { __typename?: 'ProjectShortVideo', id: string, title: string, description: string, thumbnail: string, videoUrl: string, priority: number, createdAt: string, updatedAt: string, archived: boolean, seoMeta?: { __typename?: 'SEOMeta', title: string, description: string, keywords: Array<string> } | null } };
...
export const UpsertByteCollectionCategoryDocument = gql`
  ...
  payload: upsertByteCollectionCategory(spaceId: $spaceId, input: $input) {
    ...
    ${ByteCollectionCategoryFragmentDoc}`;
export type UpsertByteCollectionCategoryMutationFn = Apollo.MutationFunction<UpsertByteCollectionCategoryMutation, UpsertByteCollectionCategoryMutationVariables>;
 ...
 * });
 */
export function useUpsertByteCollectionCategoryMutation(baseOptions?: Apollo.MutationHookOptions<UpsertByteCollectionCategoryMutation, UpsertByteCollectionCategoryMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useUpdateSeoOfProjectByteMutation(baseOptions?: Apollo.MutationHookOptions<UpdateSeoOfProjectByteMutation, UpdateSeoOfProjectByteMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export const UpdateSeoOfProjectByteCollectionDocument = gql`
  ...
  updateSeoOfProjectByteCollection(projectId: $projectId, seoMeta: $seoMeta) {
    ...
    ${ProjectByteCollectionFragmentDoc}`;
export type UpdateSeoOfProjectByteCollectionMutationFn = Apollo.MutationFunction<UpdateSeoOfProjectByteCollectionMutation, UpdateSeoOfProjectByteCollectionMutationVariables>;
 ...
 * });
 */
export function useUpdateSeoOfProjectByteCollectionMutation(baseOptions?: Apollo.MutationHookOptions<UpdateSeoOfProjectByteCollectionMutation, UpdateSeoOfProjectByteCollectionMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateSeoOfProjectByteCollectionMutation, UpdateSeoOfProjectByteCollectionMutationVariables>(UpdateSeoOfProjectByteCollectionDocument, options);
      }
...
export type UpdateSeoOfProjectByteCollectionMutationOptions = Apollo.BaseMutationOptions<UpdateSeoOfProjectByteCollectionMutation, UpdateSeoOfProjectByteCollectionMutationVariables>;
...
export const UpdateSeoOfProjectShortVideoDocument = gql`
  ...
  updateSeoOfProjectShortVideo(projectId: $projectId, seoMeta: $seoMeta) {
    ...
    ${ProjectShortVideoFragmentDoc}`;
export type UpdateSeoOfProjectShortVideoMutationFn = Apollo.MutationFunction<UpdateSeoOfProjectShortVideoMutation, UpdateSeoOfProjectShortVideoMutationVariables>;
 ...
 * });
 */
export function useUpdateSeoOfProjectShortVideoMutation(baseOptions?: Apollo.MutationHookOptions<UpdateSeoOfProjectShortVideoMutation, UpdateSeoOfProjectShortVideoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export type UpdateSeoOfProjectShortVideoMutationOptions = Apollo.BaseMutationOptions<UpdateSeoOfProjectShortVideoMutation, UpdateSeoOfProjectShortVideoMutationVariables>;
