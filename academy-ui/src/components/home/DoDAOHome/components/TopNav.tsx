...
import { AcademicCapIcon, Bars3Icon, ClipboardIcon, FingerPrintIcon, XMarkIcon } from '@heroicons/react/24/outline';
import { useState } from 'react';

const products = [
  { name: 'Tidbits Hub', description: 'Get a better understanding of your traffic', href: '#', icon: ClipboardIcon },
  { name: 'Academy Sites', description: 'Speak directly to your customers', href: '#', icon: AcademicCapIcon },
  { name: 'Decentralized Reviews', description: 'Your customers’ data will be safe and secure', href: '#', icon: FingerPrintIcon },
];
const callsToAction = [
      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <Popover className="relative">
            ...
            >
              {company.map((item) => (
                <a key={item.name} href={item.href} className="block rounded-lg px-3 py-2 text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-50">
                  {item.name}
                </a>
              ))}
            </PopoverPanel>
