...
export function Hero() {
  return (
    <div className="pb-16 pt-20 text-center lg:pt-32 w-full">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-heading sm:text-7xl">
        Empower Your Customers with{' '}
        <span className="relative whitespace-nowrap text-primary">
          <svg aria-hidden="true" viewBox="0 0 418 42" className="absolute left-0 top-2/3 h-[0.58em] w-full fill-link/70" preserveAspectRatio="none">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-body">
