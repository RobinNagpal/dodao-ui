...
pyenv install 3.11
pyenv local 3.11  # Activate Python 3.9 for the current project
poetry install
...
1. Add a module which is the current folder.
2. Add a Python SDK. When adding a SDK you will see the option to use poetry env.
3. Base interpreter is penv which is installed
4. Poetry executable can be founding using `which poetry`
