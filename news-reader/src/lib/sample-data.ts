...
export const defaultTemplates: NewsTopicTemplateType[] = [
  {
    ...
    availableFilters: ['Financial Changes', 'Product Launches', 'Core Management Changes', 'Partnership Announcements', 'Market Expansion', 'Regulatory Updates', 'Technology Breakthroughs', 'Legal Issues'],
    isDefault: true,
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  },
  {
    ...
    availableFilters: ['Financial Changes', 'Partnership Announcements', 'Product Launches', 'Market Expansion', 'Core Management Changes', 'Technology Breakthroughs', 'Acquisition News', 'Funding Rounds'],
    isDefault: true,
    createdAt: new Date(),
    updatedAt: new Date(),
    createdBy: 'sample-data',
  ...
  },
  {
    ...
    availableFilters: ['Financial Changes', 'Regulatory Updates', 'Core Management Changes', 'Acquisition News', 'Legal Issues', 'Market Expansion', 'Partnership Announcements', 'Product Launches', 'Shareholder Actions'],
    isDefault: true,
    createdAt: new Date(),
    updatedAt: new Date(),
    createdBy: 'sample-data',
  ...
  },
  {
    ...
    availableFilters: ['Regulatory Updates', 'Product Launches', 'Financial Changes', 'Legal Issues', 'Clinical Trials', 'Patent Filings', 'Partnership Announcements', 'Research Breakthroughs', 'Acquisition News'],
    isDefault: true,
    createdAt: new Date(),
    updatedAt: new Date(),
    createdBy: 'sample-data',
  ...
  },
  {
    ...
    availableFilters: ['Regulatory Updates', 'Technology Breakthroughs', 'Partnership Announcements', 'Market Expansion', 'Security Incidents', 'Financial Changes', 'Legal Issues', 'Protocol Updates', 'Community Governance'],
    isDefault: true,
    createdAt: new Date(),
    updatedAt: new Date(),
    createdBy: 'sample-data',
