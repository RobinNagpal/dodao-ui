...
| Metric | **QQQ** (passive pick) | **FBCG** (active pick) |
|---|---|---|
| Style | Passive index | Actively managed (Sonu Kalra since 2009 on the underlying FBGRX mutual fund) |
| Benchmark | Nasdaq-100 Index (NDX) | Russell 1000 Growth |
| Top index to compare active to | n/a — IS an index tracker | Has beaten Nasdaq-100 by ~0 pp/yr over 10y (matches) and Russell 1000 Growth by ~+3 pp/yr over 10y net of fees (via FBGRX) |
| **Expense ratio** | 0.20% | 0.59% |
| Expense vs same-index competitors | QQQM tracks the same Nasdaq-100 at **0.15%** (5 bps cheaper) — better for pure buy-and-hold. QQQ's edge is liquidity + the deepest equity-options chain on Earth | VONG (Russell 1000 Growth passive) at **0.07%** — FBCG must clear a ~52 bps/yr active hurdle. FBGRX has cleared it by ~200–300 bps/yr historically |
| Tracking diff vs index (1y / 3y / 5y / 10y / 15y) | < 5 bps / yr across every window — near-perfect tracking, all five horizons | n/a (active). vs Russell 1000 Growth via FBGRX: 1y ~+2 pp, 3y ~+2 pp, 5y ~+3 pp, 10y ~+1 pp, 15y ~+2 pp |
...
| Bid-ask spread | ~0.5–1 bp during market hours — among the tightest globally | ~5–10 bps during market hours — trivial for retail-size positions |
