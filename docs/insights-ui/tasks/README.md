...
- **[overall_task.md](overall_task.md)** — Site-wide tasks + user feedback that apply across stocks, ETFs, tariffs, scenarios (themes, retention, AI-platform traffic, search/analytics research, Vercel cost optimization).
