...
- `insights-ui/etf-prompts/key-facts.md` — `KeyFacts` (the plain-English "important things to know" paragraphs plus the green/red flag Pass/Fail assessments; formerly "index-strategy").
