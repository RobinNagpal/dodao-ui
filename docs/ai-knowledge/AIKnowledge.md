...
- **ETF analysis pipeline** — [insights-ui/etf-analysis/AIKnowledge.md](insights-ui/etf-analysis/AIKnowledge.md) covers [generate-etf-reports.md](insights-ui/etf-analysis/generate-etf-reports.md) (how to enqueue ETF reports via the `etfs:trigger` script, with the 50-ETF cap and 10s per-ETF delay), the [market-scenarios catalog](insights-ui/etf-analysis/etf-market-scenarios.md), and the [scenarios implementation checklist](insights-ui/etf-analysis/etf-scenarios-implementation-checklist.md).
