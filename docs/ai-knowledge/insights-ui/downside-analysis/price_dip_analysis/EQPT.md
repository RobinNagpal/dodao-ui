...
**Current price:** ~$20.50 (March 31, 2026)
**IPO price:** $24.50 (January 23, 2026)
**All-time high:** $35.50 (January 28, 2026 — 5 days after IPO)
**Already down:** ~42% from ATH, ~16% below IPO price

EquipmentShare posted FY 2025 revenue of $4.38B (+16% YoY), net income of $40M (+1,233% from $3M in 2024), adjusted Core EBITDA of $1.67B, operating income of $297M (+36%), and operating cash flow of $264M. Guided FY 2026 revenue $5.05–5.47B (+15–25%), EBITDA $1.81–1.93B, rental revenue $3.31–3.59B (+27%), and 421–429 locations (from 385). Fleet OEC at year-end $8.78B, projected $9.98–11.03B for 2026.

**Business context:** EQPT is the #3 U.S. construction equipment rental company behind United Rentals ($15B+ revenue) and Sunbelt Rentals (~$10B). IPO'd in January 2026 at $24.50, raising $747M. The company differentiates via its T3 technology platform (real-time fleet tracking, telematics) and the OWN Program (capital-light asset-backed financing). 385 locations, 252K rental fleet units. Revenue split: Rental & Services $2.72B (+34%), Equipment Sales $1.54B (-8%), Other $114M (+116%). Highly leveraged: Debt/Equity 4.78x, Net Debt/EBITDA 6.11x. The stock has never traded above its first-week high of $35.50.
...
## The EQPT Story: Hyper-Growth Rentals, Extreme Leverage

EQPT has a dramatic split profile:
- **Strengths:** Revenue growing 16–47% per year. Rental segment growing 34% with 54% EBITDA margin at mature sites. 16.5% ROIC at mature sites. T3 technology platform is a genuine differentiator. 95 new locations in 2025 alone. Equipment sales declining (normalizing) but rental revenue accelerating.
- **Weaknesses:** Net Debt/EBITDA of 6.11x is dangerously high — peers United Rentals and Sunbelt operate at 2.0–2.5x. ROIC of 4.92% company-wide (vs. 16.5% at mature sites) means new sites are destroying value while ramping. Net income of $40M on $4.38B revenue = 0.9% net margin. Interest expense consumes almost all operating income. Free cash flow is negative due to massive fleet capex. IPO dilution of -193% (one-time).

**Why the stock is below IPO:** The January IPO priced at the peak of optimism. Since then, construction spending fears (tariff uncertainty, interest rates) have pressured the entire equipment rental sector. EQPT's extreme leverage (6.1x Net Debt/EBITDA vs. peers at 2.0–2.5x) makes it the most leveraged play in the space — great when construction booms, devastating when it slows.
...
| Scenario | Business Trigger | Price Range | Change from $20.50 | Probability |
|----------|-----------------|-----------|---------------------|-------------|
| Construction strong | Infrastructure booms, rental +30%, EBITDA grows to $1.9B | $28–31 | +35 to 50% | 15% |
| Low-end guidance | Growth holds, leverage stays elevated, lockup expires | $16.50–18 | -12 to 20% | 30% |
| Construction slowdown | Tariffs freeze projects, EBITDA misses, leverage spikes to 7x+ | $12.50–15 | -28 to 38% | 35% |
| Recession + debt spiral | Construction declines, leverage 8–10x, fleet liquidation risk | $7–10 | -50 to 65% | 20% |

**Probability-weighted expected price: ~$15.50** (approximately 24% further downside from $20.50).

---

## EQPT vs Our Other Stocks

| Factor | ZBRA | DUOL | VITL | ZG | EQPT |
|--------|------|------|------|-----|------|
| Already down from high | -43% | -83% | -75% | -55% | -42% |
| Expected further downside | -22% | -21% | -8% | -24% | **-24%** |
| Prob of any further dip | 80% | 85% | 65% | 85% | **85%** |
| Balance sheet | Leveraged (3.0x) | Fortress | Strong | Good (net cash) | **Extreme (6.1x)** |
| ROIC | 8% | 52% | 30% | -0.93% | **4.9%** |
| Nature of risk | Financial/macro | Narrative | Commodity | Competitive+macro | **Leverage+cyclical** |
| Worst case floor | $90 (-55%) | $42 (-55%) | $7.75 (-42%) | $18 (-55%) | **$7 (-65%)** |

**Key insight:** EQPT has the deepest worst-case downside (-65%) of all five stocks because its 6.1x Net Debt/EBITDA amplifies any cyclical downturn into a potential debt crisis. The business is genuinely strong (34% rental growth, 54% mature site margins, T3 technology platform), but the financial structure means shareholders eat the first loss if construction spending stalls. EQPT is essentially a leveraged bet on U.S. construction continuing to grow — if it does, the stock recovers handsomely; if it doesn't, the debt absorbs most of the equity value.

**Ranking (least to most further downside): VITL (-8%) > DUOL (-21%) > ZBRA (-22%) > ZG (-24%) = EQPT (-24%)**

EQPT ties with ZG on probability-weighted downside (-24%) but has the worst tail risk (floor of $7 vs. ZG's $18) due to the leverage amplification effect.

---

## Key Catalysts and Timing (EQPT)
