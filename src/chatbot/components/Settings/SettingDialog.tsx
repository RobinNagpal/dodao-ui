...
import { getSettings, saveSettings } from '@/chatbot/utils/app/settings';

import { Settings } from '@/chatbot/types/settings';
      ...
      <div className="fixed inset-0 z-10 overflow-hidden">
        <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div
            ...
            role="dialog"
          >
            <div className="text-lg pb-4 font-bold">{t('Settings')}</div>

            <div className="text-sm font-bold mb-2">{t('Theme')}</div>
            ...
            <button
              type="button"
              className="w-full px-4 py-2 mt-6 border rounded-lg shadow border-neutral-500 hover:bg-neutral-100 focus:outline-none dark:border-neutral-800 dark:border-opacity-50"
              onClick={() => {
                handleSave();
                onClose();
              }}
