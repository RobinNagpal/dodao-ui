...
import { PluginID, PluginKey } from '@/chatbot/types/plugin';
...
export const PluginKeys = () => {
  ...
  return (
    <>
      ...
      {isChanging && (
        <div className="z-100 fixed inset-0 flex items-center justify-center bg-black bg-opacity-50" onKeyDown={handleEnter}>
