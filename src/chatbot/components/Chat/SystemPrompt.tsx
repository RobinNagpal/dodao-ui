...
import { DEFAULT_SYSTEM_PROMPT } from '@/chatbot/utils/app/const';
...
export const SystemPrompt: FC<Props> = ({ conversation, prompts, onChangePrompt }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      {isModalVisible && (
        <VariableModal prompt={prompts[activePromptIndex]} variables={variables} onSubmit={handleSubmit} onClose={() => setIsModalVisible(false)} />
      )}
    </div>
  );
};
