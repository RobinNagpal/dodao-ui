                  ...
                  <>
                    <dt>
                      <Disclosure.Button className="flex w-full items-start justify-between text-left">
                        <span className="text-sm font-semibold leading-7" dangerouslySetInnerHTML={{ __html: marked.parse(faq.question, { renderer }) }} />
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-xs leading-7 pl-2 border-b mb-4 pb-4" dangerouslySetInnerHTML={{ __html: marked.parse(faq.answer, { renderer }) }} />
                    </Disclosure.Panel>
                  </>
                )}
              </Disclosure>
