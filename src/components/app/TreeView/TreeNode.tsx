  ...
  return (
    <div className="px-4 py-2">
      <div className="flex items-center cursor-pointer" onClick={handleClick}>
        {node.children &&
          !isQuestionsNode &&
          !isChapterSubmissionsNode && // Add condition to exclude "Questions" and "Chapter Submissions"
          (isOpen ? <ChevronDownIcon className="h-5 w-5 mr-2" /> : <ChevronRightIcon className="h-5 w-5 mr-2" />)}
        {node.component}
      </div>
