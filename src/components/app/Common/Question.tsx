...
import { ByteQuestionFragment, CourseQuestionFragment, GuideQuestionFragment } from '@/graphql/generated/generated-types';
...
interface LocalQuestionType extends Omit<CourseQuestionFragment | GuideQuestionFragment | ByteQuestionFragment, 'hint' | 'explanation'> {
  hint?: string;
  explanation?: string;
}
