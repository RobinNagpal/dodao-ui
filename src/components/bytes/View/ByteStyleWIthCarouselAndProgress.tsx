...
import StepIndicatorProgress from '@/components/app/Progress/StepIndicatorProgress';

interface ByteStyleWithCarouselAndProgressProps {
...
function ByteStyleWithCarouselAndProgress({ viewByteHelper, step, byte, space }: ByteStyleWithCarouselAndProgressProps) {
...
export default ByteStyleWithCarouselAndProgress;
