...
import styles from './ByteStyleWithCarouselAndProgress1.module.scss';
import StepIndicatorProgress from '@/components/bytes/View/NewByteStyles/Progress/StepIndicatorProgress';

interface ByteStyleWithCarouselAndProgress1Props {
...
function ByteStyleWithCarouselAndProgress1({ viewByteHelper, step, byte, space }: ByteStyleWithCarouselAndProgress1Props) {
...
export default ByteStyleWithCarouselAndProgress1;
