        ...
        {timeline.events.map((event, i) => {
          ...
          return (
            <li key={i} className="relative flex gap-x-4 items-center">
              <div className="absolute left-0 top-0 flex w-5 justify-center -bottom-6 mr-4 z-10">
                <div className="w-px bg-gray-200"></div>
              </div>
              <div className="flex items-center">
                <div className="rounded-full bg-white h-8 w-5 flex items-center justify-center rounded-full relative z-20">
              ...
              <div className="flex-auto rounded-md ring-1 ring-inset ring-gray-200">
                <div className="flex justify-between gap-x-4">
                  <div className="text-xs leading-5 text-gray-500 p-4 pb-0">
                    <span className="font-medium text-lg text-gray-900">{event.name}</span>
                  </div>
