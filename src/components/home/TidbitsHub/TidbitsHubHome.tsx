    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-3xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">TidbitsHub:</span>
        </span>{' '}
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            Mastering Customer Engagement: TidbitsHub&apos;s Pioneering Platform and Resources
          </h2>
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            Discover all you need for superior customer education with TidbitsHub&apos;s innovative features. Just dive in, and don&apos;t sweat the small stuff
...
const features = [
  {
    ...
    description:
      "TidbitsHub is more than a platform; it's a complete solution for customer education. It empowers your customers with vital knowledge, helping them utilize your products and services to their fullest potential.",
  ...
  },
  {
    ...
    description:
      'TidbitsHub believes in the power of information for cost-efficiency. By providing all necessary information to your customers, you can significantly minimize your support-related expenses.',
  ...
  },
  {
    ...
    description:
      'TidbitsHub transforms every customer interaction into a learning experience. By fostering dynamic education, it helps turn your customers into brand advocates.',
  ...
  },
  {
    ...
    description:
      'TidbitsHub goes beyond business transactions to create lasting relationships with your customers. Continuous learning and engagement are key to nurturing these bonds.',
  ...
  },
  {
    ...
    description:
      'TidbitsHub paves the way for customer discovery with clear and comprehensive explanations of your products and services. This instills a sense of trust and empowerment in your customers.',
  ...
  },
  {
    ...
    description:
      'With TidbitsHub, customer engagement is not just a goal, but a journey. Our education platform keeps customers more engaged and connected than ever, significantly reducing churn and increasing loyalty.',
    ...
    <section id="secondary-features" aria-label="Features for simplifying everyday business tasks" className="pb-14 pt-20 sm:pb-20 sm:pt-32 lg:pb-32">
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">TidbitsHub: Revolutionizing Customer Engagement</h2>
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            With TidbitsHub, empower your customers, streamline support costs, and cultivate enduring relationships through comprehensive, engaging education.
          </p>
        </div>
      ...
      <Container className="relative">
        <div className="mx-auto max-w-lg text-center">
          ...
          <p className="mt-4 text-lg tracking-tight text-white">
            Welcome to your trial with TidbitsHub, your gateway to revolutionizing customer education. Experience cost-efficiency, customer empowerment,
            engagement, and reduced churn while gaining valuable customer insights. Embark on a journey to redefine your customer relationships today.
          </p>
      ...
      <Container>
        <div className="md:text-center">
          ...
          <p className="mt-4 text-lg text-slate-400">
            {
              "TidbitsHub's customer education platform empowers businesses to engage, educate, and retain customers by sharing all the information they need, reducing the need for costly support teams and improving customer satisfaction."
            }
          </p>
        </div>
...
const faqs = [
  [
    {
      question: 'What is TidbitsHub?',
      answer:
        'TidbitsHub is a comprehensive customer education platform designed to empower businesses to effectively share knowledge about their products and services. It enables you to engage, educate, and cultivate long-lasting relationships with your customers, while also reducing support costs.',
    },
    {
      question: 'How can TidbitsHub help me save on support costs?',
      answer:
        'By offering a robust platform where customers can easily access all the information they need, TidbitsHub reduces the reliance on customer support teams. This means lower overhead costs for your business and faster, more efficient customer service.',
    },
    {
      question: 'How does TidbitsHub engage and educate customers?',
      answer:
        'TidbitsHub offers a variety of interactive educational resources, including guides, quizzes, bite-sized content, clickable demos, and more. These engaging tools make learning about your products and services both fun and effective for your customers.',
    },
  ],
  [
    {
      question: 'How does TidbitsHub help create long-term customer relationships?',
      answer:
        'By providing comprehensive and accessible knowledge, TidbitsHub fosters trust and satisfaction among your customers. This, combined with continuous learning opportunities, helps to build strong, lasting relationships.',
    },
    {
      question: 'How does TidbitsHub empower customers?',
      answer:
        'TidbitsHub empowers customers by providing them with the tools and resources they need to fully understand and appreciate your products or services. It helps customers to become more confident and capable, which enhances their overall experience with your brand.',
    },
    {
      question: 'How does TidbitsHub reduce churn rates?',
      answer:
        'By providing engaging, user-friendly educational content, TidbitsHub keeps customers invested in your brand. This high level of engagement reduces churn rates by promoting customer loyalty and satisfaction.',
    },
  ],
  [
    {
      question: 'What insights can I gain about my customers through TidbitsHub?',
      answer:
        "TidbitsHub provides valuable insights into your customers' behaviors and preferences through their interactions with the platform's educational content. This data can be used to personalize customer experiences and further enhance satisfaction and loyalty.",
    },
    {
      question: 'What kinds of businesses can benefit from TidbitsHub?',
      answer:
        "Any business that aims to provide its customers with comprehensive knowledge about its products or services can benefit from TidbitsHub. Whether you're a small start-up or a large corporation, TidbitsHub can be tailored to meet your specific customer education needs.",
    },
    {
      question: 'How do I get started with TidbitsHub?',
      answer:
        'Getting started with TidbitsHub is simple. Choose the pricing plan that suits your business needs and start your journey towards enhanced customer education and engagement. For any specific queries or customized requirements, feel free to contact our support team.',
    },
  ],
];
    ...
    <footer className="bg-slate-50">
      <Container>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">Copyright &copy; {new Date().getFullYear()} TidbitsHub. All rights reserved.</p>
        </div>
      </Container>
    </footer>
  );
...
export default function TidbitsHubHome() {
  return (
    <>
      <Head>
        <title>TidbitsHub</title>
        <meta
          name="description"
          content="TidbitsHub is the ultimate web3 education platform for individuals and businesses, simplifying complex blockchain and decentralized finance concepts to help users succeed in this rapidly evolving industry."
        />
      </Head>
      <main>
        <Hero />
