              ...
              <div className="lg:max-w-lg">
                ...
                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 lg:max-w-none">
                  <div className="relative pl-9">
                    ...
                    <dd className="inline">
                      &nbsp;Users can watch concise, one-minute videos embedded within tidbits as we are aware that everyone has their own unique learning
                      style.
                    </dd>
                  </div>
                  <div className="relative pl-9">
                  ...
                  <div className="relative pl-9">
                    ...
                    <dd className="inline">&nbsp;We can embed CTAs within tidbits that lead customers directly to application forms etc.</dd>
                  </div>
                </dl>
              </div>
            </div>
