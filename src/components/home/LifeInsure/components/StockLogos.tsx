...
export function DiageoLogo(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
...
export function ReversableLogo(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 40 40" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="square" strokeLinejoin="round" aria-hidden="true" {...props}>
