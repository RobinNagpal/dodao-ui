    ...
    <div className={'my-2 ' + (className || '')}>
      ...
      <div className="relative mt-2 rounded-md shadow-sm">
        <input
          id={id || inputId}
          ref={inputRef}
          className={`block w-full rounded-md border-0 p-1.5 pr-10 ring-1 ring-inset ring-[var(--border-color)] shadow-sm focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6 ${
            styles.styledInput
          } ${error ? styles.error : ''}`}
          value={modelValue || ''}
