  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={onClose}>
        ...
        <div
          className={`${styles.modalContainer} fixed inset-0 z-10 overflow-y-auto flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0`}
        >
          <Transition.Child
            as={Fragment}
            enter="ease-out duration-300"
          ...
          >
            <Dialog.Panel className="background-color z-15 border border-color relative transform overflow-hidden rounded-lg p-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
              {showCloseButton && (
