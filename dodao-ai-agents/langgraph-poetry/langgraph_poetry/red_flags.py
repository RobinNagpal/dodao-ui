...
def extract_industry_details_node(state: State):
    ...
    prompt = (
        ...
        "We want an overview of the industry, potential challenges, unique benefits, growth trends, etc. "
        "Focus only on the industry context, not the startup's internal details.\n\n"
        f"{combined_text}\n\n"
        "Return only the textual summary of industry details, as concise as possible."
    )
