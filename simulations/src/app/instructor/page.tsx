  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-gray-200/30 rounded-full blur-xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-20 left-1/4 w-40 h-40 bg-gray-200/20 rounded-full blur-xl animate-pulse delay-2000"></div>
      </div>
