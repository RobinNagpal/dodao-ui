...
export default function EditCaseStudyModal({ isOpen, onClose, onSuccess, caseStudyId }: EditCaseStudyModalProps) {
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <MarkdownEditor
                        ...
                        onUpdate={(value) => updateModule(moduleIndex, 'details', value)}
                          ...
                          <div className="space-y-2">
                            ...
                            <div>
                              <MarkdownEditor
                                ...
                                onUpdate={(value) => updateExercise(moduleIndex, exerciseIndex, 'details', value)}
